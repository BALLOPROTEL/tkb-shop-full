...
const Hero = ({ searchTerm, setSearchTerm }) => {
    return (
        <section className="relative w-full overflow-hidden bg-[#fff0f5]">
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-12 py-10 sm:py-12 md:py-20">
                <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
                    {/* GAUCHE : MESSAGE ET RECHERCHE */}
                    <div className="w-full lg:w-1/2 space-y-8 text-center lg:text-left">
                        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-pink-100 border border-pink-200 text-pink-600 text-[9px] sm:text-[10px] font-bold uppercase tracking-widest">
                            <Sparkles size={12} /> L'Excellence au féminin
                        </div>

                        <h1 className="text-4xl sm:text-5xl md:text-7xl font-serif text-slate-900 leading-tight">
                            Sublimez votre <br />
                            <span className="italic text-pink-600">Féminité.</span>
                        </h1>

                        <p className="text-slate-500 text-sm sm:text-base font-light max-w-lg leading-relaxed">
                        ...
                        <div className="relative max-w-md mx-auto lg:mx-0 group">
                            <input
                                ...
                                className="w-full bg-white border-2 border-pink-100 py-3 sm:py-4 px-10 sm:px-12 text-sm rounded-2xl shadow-sm focus:border-pink-500 transition-all outline-none"
                            />
                    ...
                    <div className="w-full lg:w-1/2 relative">
                        <div className="absolute -top-10 -right-10 w-56 h-56 sm:w-64 sm:h-64 bg-pink-200 rounded-full blur-3xl opacity-50"></div>
                        <div className="relative rounded-3xl sm:rounded-[40px] overflow-hidden border-8 border-white shadow-2xl">
                            <img
                            ...
                            />
                            <div className="absolute bottom-4 right-4 sm:bottom-6 sm:right-6 bg-white/90 backdrop-blur-md p-3 sm:p-4 rounded-2xl shadow-lg border border-pink-100">
                                <p className="text-[9px] sm:text-[10px] font-bold text-pink-600 uppercase mb-1">Coup de cœur</p>
                                <p className="text-xs sm:text-sm font-bold text-slate-900">Abaya "Sultana" Gold</p>
