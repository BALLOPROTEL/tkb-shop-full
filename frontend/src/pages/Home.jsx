    ...
    useEffect(() => {
        const fetchProducts = async () => {
            try {
                ...
                // Avec Axios, les donnees sont dans res.data
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-12 py-12 sm:py-20">
                <div className="text-center mb-20 space-y-4">
                    <div className="flex items-center justify-center gap-2 text-pink-500 animate-pulse">
                        <Sparkles size={16} />
                        <span className="text-[9px] sm:text-[10px] font-black uppercase tracking-[0.25em] sm:tracking-[0.4em]">SELECTION EXCLUSIVE</span>
                    </div>
                    <h2 className="text-3xl sm:text-4xl md:text-5xl font-serif text-slate-900">Pieces d'exception</h2>
